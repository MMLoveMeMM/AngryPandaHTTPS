#include<jni.h>
#include "com_panda_org_opensslwrapper_OpenSLLCore.h"
#include "jni_log.h"
...
/*
 * Class:     com_panda_org_opensslwrapper_OpenSLLCore
 * Method:    generateKey
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_panda_org_opensslwrapper_OpenSLLCore_generateKey
  (JNIEnv *, jclass)
  {
    RSA *rsa = generateKey();
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_panda_org_opensslwrapper_OpenSLLCore_releaseKey
  (JNIEnv *, jclass)
  {
    RSA_free(mPublicKey);
 ...
 * Signature: ([B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_panda_org_opensslwrapper_OpenSLLCore_rsaEncrypt
 ...
 * Signature: ([B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_panda_org_opensslwrapper_OpenSLLCore_rsaDecrypt
  (JNIEnv *env,jclass cls,jbyteArray byteArray)
  {
    unsigned char *cstr = jbyteArrayToUChar(env, byteArray);
 ...
 */
JNIEXPORT jstring JNICALL Java_com_panda_org_opensslwrapper_OpenSLLCore_getPublicKey
 ...
 */
JNIEXPORT jbyteArray JNICALL Java_com_panda_org_opensslwrapper_OpenSLLCore_rsaEncryptByExtPublicKey
